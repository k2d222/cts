...
import { ErrorWithExtra, assert, range, unreachable } from '../../../../common/util/util.ts';
import { InterpolationSampling, InterpolationType } from '../../../constants.ts';
import { kTextureFormatInfo } from '../../../format_info.ts';
import { GPUTest, TextureTestMixin } from '../../../gpu_test.ts';
import { getProvokingVertexForFlatInterpolationEitherSampling } from '../../../inter_stage.ts';
import { getMultisampleFragmentOffsets } from '../../../multisample_info.ts';
import { dotProduct, subtractVectors, align } from '../../../util/math.ts';
